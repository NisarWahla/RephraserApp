...
//radius of the slider pics corners
        cornerRadius = typedArray.getInt(R.styleable.ImageSlider_corner_radius, 10)
        ...
        placeholder =
            typedArray.getResourceId(R.styleable.ImageSlider_placeholder, R.drawable.loading)
